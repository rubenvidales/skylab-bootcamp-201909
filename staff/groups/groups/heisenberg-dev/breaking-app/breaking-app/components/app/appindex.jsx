    ...
    return class extends Component {
        ...
        handleGoToProfile = () => {
            retrieveUser(id, token, (error, data) => {
                this.setState({ view:'profile', profile: data })
            })
        }
        ...
        render() {
            const { state: { view, user, profile }, handleGoToLogin, handleGoToRegister, handleGoBackToLanding, handleGoToProfile, handleGoToSearch, handleRegister, handleLogin, handleLogout, handleProfile } = this
            return <>
                ...
                {view === 'profile' && <Profile onBack={handleGoToSearch} onEdit={handleProfile} data={profile} />}
            </>
        }
    }
})()