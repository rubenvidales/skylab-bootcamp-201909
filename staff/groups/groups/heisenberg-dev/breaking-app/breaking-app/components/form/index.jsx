function Form({ back, onAction, button, onData}) {
    return <form className="register__form" onSubmit={function (event) {
        ...
        <input className="register__field" type="text" name="name" placeholder="name" defaultValue={onData.name}  />
        <input className="register__field" type="text" name="surname" placeholder="surname" defaultValue={onData.surname} />
        <input className="register__field" type="email" name="email" placeholder="e-mail" defaultValue={onData.username}  />
